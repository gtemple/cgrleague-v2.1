...
DATA = [
    ...
    dict(first_name="Nicholas", last_name="Latifi",   initials="LAT", city_of_birth="Toronto", country_of_birth="Canada", human=False, date_of_birth=date(1995, 6,29),  profile_image="nicholas-latifi", country_of_representation="canada"),
    ...
    dict(first_name="George",   last_name="Russell",  initials="RUS", city_of_birth="King's Lynn", country_of_birth="United Kingdom", human=False, date_of_birth=date(1998, 2,15), profile_image="george-russell", country_of_representation="united-kingdom"),
    ...
    dict(first_name="Sergio",   last_name="Pérez",    initials="PER", city_of_birth="Guadalajara", country_of_birth="Mexico", human=False, date_of_birth=date(1990, 1,26), profile_image="sergio-perez", country_of_representation="mexico"),
    ...
    dict(first_name="Guanyu",   last_name="Zhou",     initials="ZHO", city_of_birth="Shanghai", country_of_birth="China",  human=False, date_of_birth=date(1999, 5,30), profile_image="guanyu-zhou", country_of_representation="china"),
    ...
    dict(first_name="Mick",     last_name="Schumacher", initials="SCH", city_of_birth="Vufflens-le-Château", country_of_birth="Switzerland", human=False, date_of_birth=date(1999, 3,22), profile_image="mick-schumacher", country_of_representation="germany"),
