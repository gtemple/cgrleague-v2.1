...
DATA = [
    ...
    dict(name="British Grand Prix", city="Silverstone", country="United Kingdom", distance=5891, layout="british-layout", img="british"),
    ...
    dict(name="Singapore Grand Prix", city="Marina Bay", country="Singapore", distance=4928, layout="singapore-layout", img="singapore"),
    ...
    dict(name="São Paulo Grand Prix", city="São Paulo", country="Brazil", distance=4309, layout="brazil-layout", img="brazil"),
    dict(name="Las Vegas Grand Prix", city="Las Vegas", country="United States", distance=6201, layout="las-vegas-layout", img="las-vegas"),
    ...
    dict(name="French Grand Prix", city="Le Castellet", country="France", distance=5842, layout="france-layout", img="france"),
